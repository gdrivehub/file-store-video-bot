...
async def plan(client, message):
    ...
    btn = [[
        ...
        InlineKeyboardButton("📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ", url=USERNAME)],[InlineKeyboardButton('🥳 𝙲𝚕𝚒𝚌𝚔 𝙷𝚎𝚛𝚎 𝚃𝚘 𝙶𝚎𝚝 𝟻𝙼𝚒𝚗𝚜 𝙵𝚛𝚎𝚎 𝚃𝚛𝚒𝚊𝚕 🎉', callback_data='give_trial')],[InlineKeyboardButton('❌ CLOSE ❌', callback_data='close_data')
    ]]
...
async def refer(client, message):
    ...
    referral_link = f"https://t.me/{temp.U_NAME}?start=ref_{user_id}"
    await message.reply_text(
        "🔗 <b>Your Referral Link</b>\n\n"
        f"<code>{referral_link}</code>\n\n"
        "Share it with friends — every new user who joins through your link earns you "
        "<b>1 day of free premium</b>, stacked on top of any plan you already have.\n\n"
        f"👥 Successful referrals so far: <b>{referral_count}</b>",
