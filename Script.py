class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {} ,
I Cᴀɴ Pʀᴏᴠɪᴅᴇ Hot & Exclusive 🔞Adult content. 
Just send the command /getvid, Watch Aɴᴅ Eɴᴊᴏʏ 😍

Also join below Exclusive channel to access 70,000+ videos🔥</b>"""
...
└ ʀᴇꜱᴜʟᴛ ꜱʜᴏᴡ ɪɴ : {remaining_seconds} <i>seconds</i>

👋 Hᴇʏ {requested} ʜᴇʀᴇ ᴀʀᴇ ʏᴏᴜʀ ʀᴇsᴜʟᴛs

ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴏɴ 5 ᴍɪɴᴜᴛᴇꜱ ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛꜱ"""
...
• /plink - <code>Jᴜsᴛ ʟɪᴋᴇ /link, ʙᴜᴛ ᴛʜᴇ ғɪʟᴇ ᴡɪʟʟ ʙᴇ sᴇɴᴅ ᴡɪᴛʜ ғᴏʀᴡᴀʀᴅ ʀᴇsᴛʀɪᴄᴛɪᴏɴ.</code>"""
 ...
 /whois :- ɢɪᴠᴇ ᴀ ᴜꜱᴇʀ ꜰᴜʟʟ ᴅᴇᴛᴀɪʟꜱ 📑 
    ...
    JSON_TXT = """<b> 
 claude ai feature use /ak {your question}
  
 example :- /ask tell python basics.</b>""" 
 ...
 • Tʜᴇꜱᴇ ᴄᴏᴍᴍᴀɴᴅꜱ ᴄᴀɴ ʙᴇ ᴜꜱᴇᴅ ʙʏ ᴀɴʏ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀ.</b>""" 
    ...
    SHARE_TXT = """<b>/lyrics ﹛ your song name ﹜ 
...
ஏய் {} 
 ...
 படி 1: இந்tha LEVII-FILTER-BOT போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey {}
 ...
 Step 1: Administer this LEVII-FILTER-BOT bot to your group
...
హే {}
 ...
 దశ 1: ఈ LEVII-FILTER-BOT బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
‼️ ᴀғᴛᴇʀ sᴇɴᴅɪɴɢ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴘʟᴇᴀsᴇ ɢɪᴠᴇ ᴜs sᴏᴍᴇ ᴛɪᴍᴇ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ ʟɪsᴛ"""
    ...
    VERIFICATION_TEXT = """<b>🙋‍♂ Hᴇʏ {}

ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪꜰɪᴇᴅ ᴛᴏᴅᴀʏ 😐
ᴛᴀᴘ ᴏɴ ᴛʜᴇ ᴠᴇʀɪꜰʏ ʟɪɴᴋ & ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ꜰᴏʀ ᴛɪʟʟ ɴᴇxt 30 minutes  😊.



<i>#ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ:- 1/2</i>

<u>ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴅɪʀᴇᴄᴛ ꜰɪʟᴇs ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀᴋᴇ ᴘʀᴇᴍɪᴜᴍ sᴇʀᴠɪᴄᴇ (ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴠᴇʀɪꜰʏ)</u>
...
ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪꜰɪᴇᴅ ᴛᴏᴅᴀʏ 😐
ᴛᴀᴘ ᴏɴ ᴛʜᴇ ᴠᴇʀɪꜰʏ ʟɪɴᴋ & ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ꜰᴏʀ ᴛɪʟʟ ɴᴇxᴛ 30 minutes 😊.


<i>#ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ:- 2/2</i>
...
ɴᴏᴡ ʏᴏᴜ ʜᴀᴠᴇ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ ғᴏʀ ᴛɪʟʟ ɴᴇxᴛ 30 minutes 😀.</b>"""

    SECOND_VERIFY_COMPLETE_TEXT = """
<b><i>Hᴇʏ ᴛʜᴇʀᴇ {} 👋</i>

ʏᴏᴜ ᴀʀᴇ ɴᴏᴡ ᴠᴇʀɪғɪᴇᴅ ғᴏʀ ᴛᴏᴅᴀʏ ✅,

ᴇɴᴊᴏʏ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇs ᴏʀ sᴇʀɪᴇs 30 minutes 😎.</b>
"""

    VERIFIED_TXT = """
<b>#USER_VERIFIED_COMPLETE
...
<a href='https://t.me/gdrivehub_backup'>𝐎𝐔𝐑 UPDATES CHANNEL</a>"""
    ...
    NO_TXT = """This Feature is under Maintenance sorry⚠️🪖"""
